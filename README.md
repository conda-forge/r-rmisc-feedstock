...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-rmisc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7421&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rmisc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rmisc` can be installed with:

```
conda install r-rmisc
```

It is possible to list all of the versions of `r-rmisc` available on your platform with:
